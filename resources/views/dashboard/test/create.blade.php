                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="value" value="{{old('name_ar')}}"
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                   id="plain_value" class="form-control" name="name_en" value="{{old('name_en')}}">
                                                            @error("name_en")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="value" value="{{old('logo_ar')}}"
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                   id="plain_value" class="form-control" name="logo_en" value="{{old('logo_en')}}">
                                                            @error("logo_en")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
