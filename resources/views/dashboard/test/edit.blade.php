                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Name ar</label>
                                                            <input type="text" id="value" value="{{$brand->getTranslation('name','ar')}}"
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            <label
                                                                for="projectinput1">Name en</label>
                                                            <input type="text"
                                                                   id="plain_value" class="form-control" name="name_en" value="{{$brand->getTranslation('name','en')}}">
                                                            @error("name_en")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Logo ar}</label>
                                                            <input type="text" id="value" value="{{$brand->getTranslation('logo','ar')}}"
                                                                   class="form-control" name="logo_ar">
                                                            @error("logo_ar")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            <label
                                                                for="projectinput1">Logo en</label>
                                                            <input type="text"
                                                                   id="plain_value" class="form-control" name="logo_en" value="{{$brand->getTranslation('logo','en')}}">
                                                            @error("logo_en")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
