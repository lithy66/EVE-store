                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                     ...
                                                     {{--  @foreach(collect(config('app.locales')) as $lang)
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="projectinput1">{{__('admin/body.name_'.$lang)}}</label>
                                                                <input type="text" id="value" value="{{old('name_'.$lang)}}"
                                                                       class="form-control" name="name_{{$lang}}">
                                                                @error("name_{{$lang}}")
                                                                <span class="text-danger">{{$message}}</span>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value=""
                                                                   id="plain_value" class="form-control" name="slug" value="{{old('slug')}}">
                                                            @error("slug")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                        </div>
