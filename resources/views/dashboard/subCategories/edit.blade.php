                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('admin.subCategories')}}"> {{__('admin/sideBar.sub category')}}</a></li>
                                <li class="breadcrumb-item active">{{__('general.edit')}} {{__('admin/sideBar.sub category')}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                          ...
                                          {{--  <div class="form-group">
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-user"
                                                                            style="font-size: 30px"></i>{{__('general.edit')}} {{__('admin/sideBar.sub category')}}
                                                </h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$category -> name}}" id="value"
